...
Everything I do will have a price tag attached to it from now on and be stable. No more charity stuff. Just ruthless working towards one goal and that's to build delightful software that makes a difference.
