...
I should genuinely lock in fully, non stop write code every second until something good comes out on the other end. And that is yet. Everything else is noise and distraction. Complaining, that's for sure.
